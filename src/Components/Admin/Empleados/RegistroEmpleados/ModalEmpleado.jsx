              ...
              <div className="row">
                ...
                <div className="col-md-4 mb-3">
                  ...
                  >
                    ...
                    {localidades.map((loc) => (
                      <option
                        key={loc.idLocalidad ?? loc.id}
                        value={loc.idLocalidad ?? loc.id}
                      >
                        {loc.NombreLocalidad ?? loc.nombre}
                      </option>
                    ))}
                  </select>
                </div>
                <div className="col-md-4 mb-3">
                  ...
                  >
                    ...
                    {(categorias || []).map((cat) => (
                      <option
                        key={cat.idCatEmpleado ?? cat.id}
                        value={cat.idCatEmpleado ?? cat.id}
                      >
                        {cat.NombreCat || cat.NombreCategoria}
                      </option>
                    ))}
                  </select>
                </div>
                <div className="col-md-4 mb-3">
                  ...
                  <select
                    ...
                    className="form-select"
                    value={formData.PermisosEmpleado}
                    onChange={handleInputChange}
                  >
                    <option value="">Seleccionar</option>
            ...
            <div className="modal-footer">
              ...
              <button
                ...
                disabled={
                  ...
                  !formData.ApellidoEmpleado.trim() ||
                  !formData.SalarioEmpleado ||
                  !formData.idCatEmpleado ||
                  (formData.DNI && dniYaExiste(formData.DNI))
                }
              >
