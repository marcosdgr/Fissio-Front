...
const FiltrosEmpleados = ({ busqueda, setBusqueda, filtro, setFiltro }) => {
  return (
      ...
      <div className="row mb-3">
        <div className="col-md-6">
          <div className="input-group">
            ...
            <input type="text" className="form-control" placeholder="Buscar por DNI, nombre o apellido..." value={busqueda} onChange={(e) => setBusqueda(e.target.value)} />
          </div>
        </div>
