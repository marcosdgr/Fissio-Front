...
const PlanCreateModal = ({ isOpen, onClose, form, handleChange, errors, onCreate, loadingOp, obrasSociales }) => {
      ...
      <div className="modal-dialog modal-lg modal-obras-dialog">
        <div className="modal-content shadow-lg">
          ...
          <div className="modal-footer">
            ...
            <button className="btn btn-primary" onClick={onCreate} disabled={loadingOp}>{loadingOp ? 'Creando...' : 'Crear plan'}</button>
          </div>
        </div>
      </div>
    </div>
