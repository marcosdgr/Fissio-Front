...
const AsistenciaEmpleado = () => {
        ...
        try {
          ...
          if (response.ok) {
            const empleado = empleados.find(
              (emp) => emp.idUsuario === userData.idUsuario
            );
            if (empleado) {
      ...
      <div className="asistencia-empleado-container">
        ...
        >
          <i
            ...
            style={{ fontSize: "3rem", color: "#0470BB" }}
          ></i>
    ...
    return (
      <div className="asistencia-empleado-container">
        ...
        >
          <h3>⚠️ Error</h3>
          <p>
            No se pudo encontrar el registro de empleado asociado a este
            usuario.
          </p>
  ...
  if (horariosSemanales.length > 0) {
    console.log(
      "📋 Primer horario completo:",
      JSON.stringify(horariosSemanales[0], null, 2)
    );
  }
              ...
              <div className="resumen-jornada">
                <div className="resumen-item">
                  ...
                  <span className="resumen-valor">
                    {formatearHora(asistenciaActual.HoraEntrada)}
                  </span>
                </div>
                <div className="resumen-item">
                  <span className="resumen-label">Salida:</span>
                  <span className="resumen-valor">
                    {formatearHora(asistenciaActual.HoraSalida)}
                  </span>
                </div>
                <div className="resumen-item">
            ...
            <div className="horarios-grid">
              {diasSemana.map((dia) => {
                ...
                return (
                  <div
                    key={dia}
                    className={`horario-card ${esHoy ? "dia-actual" : ""} ${
                      horariosDelDia.length === 0 ? "sin-horario" : ""
                    }`}
                  >
                      ...
                      horariosDelDia.map((horario, index) => (
                        <div key={index} className="horario-horas">
                          <div className="hora-item">
                            <i className="fas fa-sign-in-alt"></i>
                            <span>
                              {formatearHora(horario.HoraEntradaEsperada) ||
                                "No disponible"}
                            </span>
                          </div>
                          ...
                          <div className="hora-item">
                            ...
                            <span>
                              {formatearHora(horario.HoraSalidaEsperada) ||
                                "No disponible"}
                            </span>
                          </div>
                ...
                <tbody>
                  {asistencias.map((asistencia) => (
                    <tr key={asistencia.idAsistencia}>
                      ...
                      <td>
                        <span
                          className={`hora-badge ${
                            asistencia.HoraSalida ? "salida" : "pendiente"
                          }`}
                        >
